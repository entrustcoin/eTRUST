...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("Block Value",    (uint64_t)GetProofOfWorkReward(0,0)));
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Entrustcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Entrustcoin is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Entrustcoin is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Entrustcoin is downloading blocks...");
