...
!define URL http://www.entrustcoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/entrustcoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\entrustcoin-qt.exe
...
OutFile entrustcoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/entrustcoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/entrustcoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\entrustcoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\entrustcoin-qt.exe
